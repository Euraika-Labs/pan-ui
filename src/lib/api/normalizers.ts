...
import { extensionCapabilitySchema, extensionSchema, toolInventoryItemSchema } from '@/lib/schemas/extension';
...
export const normalizeSkills = (input: unknown) => skillSchema.array().parse(input);
export const normalizeExtension = (input: unknown) => extensionSchema.parse(input);
export const normalizeExtensions = (input: unknown) => extensionSchema.array().parse(input);
export const normalizeExtensionCapability = (input: unknown) => extensionCapabilitySchema.parse(input);
export const normalizeToolInventory = (input: unknown) => toolInventoryItemSchema.array().parse(input);
